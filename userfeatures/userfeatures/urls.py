...
urlpatterns = [
    ...
    path("project/<int:project_id>/tag/delete", views.tag_delete, name="tag_delete"),
    ...
    path("project/<int:project_id>/feature/delete", views.feature_delete, name="feature_delete"),
    ...
    path("project/<int:project_id>/feature/<int:feature_id>/tag/remove", views.feature_tag_remove, name="feature_tag_remove"),
